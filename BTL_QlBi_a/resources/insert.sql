...
-- ==========================================
-- DỮ LIỆU HÓA ĐƠN MẪU CHO CHỨC NĂNG THỐNG KÊ
-- Tháng 10-11/2025
-- ==========================================

-- HÓA ĐƠN THÁNG 10/2025 (35 hóa đơn)
INSERT INTO hoa_don (ma_ban, ma_kh, ma_nv, thoi_gian_bat_dau, thoi_gian_ket_thuc, tien_ban, tien_dich_vu, giam_gia, tong_tien, phuong_thuc_thanh_toan, trang_thai, ghi_chu_giam_gia, ghi_chu) VALUES
-- Tuần 1 tháng 10 (8 hóa đơn)
(1, 1, 3, '2025-10-01 09:00:00', '2025-10-01 11:30:00', 150000, 180000, 30000, 300000, N'Tiền mặt', N'Đã thanh toán', N'Giảm 30k - VIP', NULL),
(3, 2, 4, '2025-10-01 14:00:00', '2025-10-01 16:30:00', 120000, 145000, 0, 265000, N'Chuyển khoản', N'Đã thanh toán', NULL, NULL),
(6, 3, 5, '2025-10-01 18:00:00', '2025-10-01 21:00:00', 150000, 220000, 20000, 350000, N'Ví điện tử', N'Đã thanh toán', N'Giảm 20k', NULL),
(14, 4, 3, '2025-10-02 10:30:00', '2025-10-02 13:00:00', 150000, 195000, 0, 345000, N'Tiền mặt', N'Đã thanh toán', NULL, NULL),
(22, 5, 4, '2025-10-02 19:00:00', '2025-10-02 22:30:00', 360000, 385000, 50000, 695000, N'Chuyển khoản', N'Đã thanh toán', N'VIP giảm 50k', N'Khách VIP'),
(9, 6, 5, '2025-10-03 08:30:00', '2025-10-03 10:30:00', 120000, 125000, 0, 245000, N'Tiền mặt', N'Đã thanh toán', NULL, NULL),
(17, 7, 3, '2025-10-03 15:00:00', '2025-10-03 17:30:00', 150000, 175000, 15000, 310000, N'Ví điện tử', N'Đã thanh toán', N'Giảm 15k', NULL),
(25, 8, 4, '2025-10-03 20:00:00', '2025-10-03 23:00:00', 360000, 315000, 45000, 630000, N'Chuyển khoản', N'Đã thanh toán', N'Giảm 45k', NULL),

-- Tuần 2 tháng 10 (9 hóa đơn)
(2, 9, 5, '2025-10-05 09:00:00', '2025-10-05 11:00:00', 90000, 105000, 0, 195000, N'Tiền mặt', N'Đã thanh toán', NULL, NULL),
(8, 10, 3, '2025-10-05 16:00:00', '2025-10-05 18:30:00', 120000, 165000, 10000, 275000, N'Ví điện tử', N'Đã thanh toán', N'Giảm 10k', NULL),
(12, 1, 4, '2025-10-06 10:00:00', '2025-10-06 12:30:00', 120000, 185000, 25000, 280000, N'Chuyển khoản', N'Đã thanh toán', N'VIP giảm 25k', NULL),
(20, 2, 5, '2025-10-06 17:00:00', '2025-10-06 19:30:00', 120000, 195000, 0, 315000, N'Tiền mặt', N'Đã thanh toán', NULL, NULL),
(24, 3, 3, '2025-10-08 11:00:00', '2025-10-08 14:00:00', 360000, 305000, 40000, 625000, N'Ví điện tử', N'Đã thanh toán', N'Giảm 40k', NULL),
(4, 4, 4, '2025-10-08 08:00:00', '2025-10-08 10:00:00', 120000, 135000, 0, 255000, N'Chuyển khoản', N'Đã thanh toán', NULL, NULL),
(10, 5, 5, '2025-10-09 15:00:00', '2025-10-09 17:30:00', 150000, 205000, 20000, 335000, N'Tiền mặt', N'Đã thanh toán', N'Giảm 20k', NULL),
(16, 6, 3, '2025-10-09 19:00:00', '2025-10-09 22:00:00', 180000, 245000, 30000, 395000, N'Ví điện tử', N'Đã thanh toán', N'Giảm 30k', NULL),
(21, 7, 4, '2025-10-10 12:00:00', '2025-10-10 14:30:00', 150000, 175000, 0, 325000, N'Chuyển khoản', N'Đã thanh toán', NULL, NULL),

-- Tuần 3 tháng 10 (9 hóa đơn)
(27, 8, 5, '2025-10-12 09:30:00', '2025-10-12 11:30:00', 150000, 155000, 15000, 290000, N'Tiền mặt', N'Đã thanh toán', N'Giảm 15k', NULL),
(5, 9, 3, '2025-10-12 16:00:00', '2025-10-12 18:30:00', 120000, 165000, 0, 285000, N'Ví điện tử', N'Đã thanh toán', NULL, NULL),
(11, 10, 4, '2025-10-13 10:00:00', '2025-10-13 12:30:00', 120000, 185000, 10000, 295000, N'Chuyển khoản', N'Đã thanh toán', N'Giảm 10k', NULL),
(18, 1, 5, '2025-10-13 18:00:00', '2025-10-13 21:00:00', 180000, 255000, 35000, 400000, N'Tiền mặt', N'Đã thanh toán', N'VIP giảm 35k', NULL),
(23, 2, 3, '2025-10-15 11:30:00', '2025-10-15 14:00:00', 150000, 215000, 0, 365000, N'Ví điện tử', N'Đã thanh toán', NULL, NULL),
(26, 3, 4, '2025-10-15 17:00:00', '2025-10-15 20:00:00', 180000, 275000, 35000, 420000, N'Chuyển khoản', N'Đã thanh toán', N'Giảm 35k', NULL),
(7, 4, 5, '2025-10-16 08:30:00', '2025-10-16 10:30:00', 120000, 145000, 0, 265000, N'Tiền mặt', N'Đã thanh toán', NULL, NULL),
(13, 5, 3, '2025-10-16 15:30:00', '2025-10-16 18:00:00', 150000, 195000, 20000, 325000, N'Ví điện tử', N'Đã thanh toán', N'Giảm 20k', NULL),
(19, 6, 4, '2025-10-17 20:00:00', '2025-10-17 23:00:00', 180000, 265000, 25000, 420000, N'Chuyển khoản', N'Đã thanh toán', N'Giảm 25k', NULL),

-- Tuần 4 tháng 10 (9 hóa đơn)
(1, 7, 5, '2025-10-19 09:00:00', '2025-10-19 11:30:00', 150000, 185000, 0, 335000, N'Tiền mặt', N'Đã thanh toán', NULL, NULL),
(6, 8, 3, '2025-10-19 14:00:00', '2025-10-19 16:30:00', 120000, 175000, 15000, 280000, N'Ví điện tử', N'Đã thanh toán', N'Giảm 15k', NULL),
(14, 9, 4, '2025-10-20 10:30:00', '2025-10-20 13:00:00', 150000, 205000, 20000, 335000, N'Chuyển khoản', N'Đã thanh toán', N'Giảm 20k', NULL),
(22, 10, 5, '2025-10-20 19:00:00', '2025-10-20 22:00:00', 360000, 345000, 55000, 650000, N'Tiền mặt', N'Đã thanh toán', N'Giảm 55k', NULL),
(3, 1, 3, '2025-10-22 08:00:00', '2025-10-22 10:00:00', 120000, 155000, 20000, 255000, N'Ví điện tử', N'Đã thanh toán', N'VIP giảm 20k', NULL),
(9, 2, 4, '2025-10-22 15:00:00', '2025-10-22 17:30:00', 150000, 195000, 0, 345000, N'Chuyển khoản', N'Đã thanh toán', NULL, NULL),
(17, 3, 5, '2025-10-23 11:00:00', '2025-10-23 13:30:00', 150000, 215000, 25000, 340000, N'Tiền mặt', N'Đã thanh toán', N'Giảm 25k', NULL),
(25, 4, 3, '2025-10-23 18:00:00', '2025-10-23 21:00:00', 360000, 335000, 50000, 645000, N'Ví điện tử', N'Đã thanh toán', N'Giảm 50k', NULL),
(2, 5, 4, '2025-10-24 09:30:00', '2025-10-24 11:30:00', 90000, 115000, 0, 205000, N'Chuyển khoản', N'Đã thanh toán', NULL, NULL);

-- HÓA ĐƠN THÁNG 11/2025 (25 hóa đơn đến ngày 11/11)
INSERT INTO hoa_don (ma_ban, ma_kh, ma_nv, thoi_gian_bat_dau, thoi_gian_ket_thuc, tien_ban, tien_dich_vu, giam_gia, tong_tien, phuong_thuc_thanh_toan, trang_thai, ghi_chu_giam_gia, ghi_chu) VALUES
-- Ngày 1-2/11 (5 hóa đơn)
(8, 6, 5, '2025-11-01 09:00:00', '2025-11-01 11:30:00', 120000, 175000, 15000, 280000, N'Tiền mặt', N'Đã thanh toán', N'Giảm 15k', NULL),
(12, 7, 3, '2025-11-01 14:00:00', '2025-11-01 16:30:00', 120000, 195000, 0, 315000, N'Chuyển khoản', N'Đã thanh toán', NULL, NULL),
(20, 8, 4, '2025-11-01 19:00:00', '2025-11-01 22:00:00', 180000, 255000, 30000, 405000, N'Ví điện tử', N'Đã thanh toán', N'Giảm 30k', NULL),
(24, 9, 5, '2025-11-02 10:30:00', '2025-11-02 13:00:00', 360000, 325000, 45000, 640000, N'Tiền mặt', N'Đã thanh toán', N'Giảm 45k', NULL),
(4, 10, 3, '2025-11-02 15:00:00', '2025-11-02 17:00:00', 120000, 145000, 0, 265000, N'Chuyển khoản', N'Đã thanh toán', NULL, NULL),

-- Ngày 3-4/11 (4 hóa đơn)
(10, 1, 4, '2025-11-03 08:30:00', '2025-11-03 10:30:00', 120000, 165000, 20000, 265000, N'Ví điện tử', N'Đã thanh toán', N'VIP giảm 20k', NULL),
(16, 2, 5, '2025-11-03 16:00:00', '2025-11-03 18:30:00', 150000, 205000, 0, 355000, N'Tiền mặt', N'Đã thanh toán', NULL, NULL),
(21, 3, 3, '2025-11-04 11:00:00', '2025-11-04 13:30:00', 150000, 185000, 25000, 310000, N'Chuyển khoản', N'Đã thanh toán', N'Giảm 25k', NULL),
(27, 4, 4, '2025-11-04 18:00:00', '2025-11-04 21:00:00', 180000, 245000, 30000, 395000, N'Ví điện tử', N'Đã thanh toán', N'Giảm 30k', NULL),

-- Ngày 5-6/11 (4 hóa đơn)
(5, 5, 5, '2025-11-05 09:00:00', '2025-11-05 11:30:00', 120000, 175000, 0, 295000, N'Tiền mặt', N'Đã thanh toán', NULL, NULL),
(11, 6, 3, '2025-11-05 15:30:00', '2025-11-05 18:00:00', 150000, 215000, 20000, 345000, N'Chuyển khoản', N'Đã thanh toán', N'Giảm 20k', NULL),
(18, 7, 4, '2025-11-06 10:00:00', '2025-11-06 12:30:00', 150000, 195000, 0, 345000, N'Ví điện tử', N'Đã thanh toán', NULL, NULL),
(23, 8, 5, '2025-11-06 19:00:00', '2025-11-06 22:00:00', 180000, 275000, 35000, 420000, N'Tiền mặt', N'Đã thanh toán', N'Giảm 35k', NULL),

-- Ngày 7-8/11 (4 hóa đơn)
(26, 9, 3, '2025-11-07 08:30:00', '2025-11-07 10:30:00', 150000, 155000, 15000, 290000, N'Chuyển khoản', N'Đã thanh toán', N'Giảm 15k', NULL),
(7, 10, 4, '2025-11-07 14:00:00', '2025-11-07 16:30:00', 120000, 165000, 0, 285000, N'Ví điện tử', N'Đã thanh toán', NULL, NULL),
(13, 1, 5, '2025-11-08 10:30:00', '2025-11-08 13:00:00', 120000, 195000, 25000, 290000, N'Tiền mặt', N'Đã thanh toán', N'VIP giảm 25k', NULL),
(19, 2, 3, '2025-11-08 17:00:00', '2025-11-08 20:00:00', 180000, 265000, 30000, 415000, N'Chuyển khoản', N'Đã thanh toán', N'Giảm 30k', NULL),

-- Ngày 9-10/11 (4 hóa đơn)
(1, 3, 4, '2025-11-09 09:00:00', '2025-11-09 11:30:00', 150000, 185000, 20000, 315000, N'Ví điện tử', N'Đã thanh toán', N'Giảm 20k', NULL),
(6, 4, 5, '2025-11-09 15:00:00', '2025-11-09 17:30:00', 120000, 175000, 0, 295000, N'Tiền mặt', N'Đã thanh toán', NULL, NULL),
(14, 5, 3, '2025-11-10 11:00:00', '2025-11-10 13:30:00', 150000, 205000, 25000, 330000, N'Chuyển khoản', N'Đã thanh toán', N'Giảm 25k', NULL),
(22, 6, 4, '2025-11-10 19:00:00', '2025-11-10 22:30:00', 360000, 365000, 60000, 665000, N'Ví điện tử', N'Đã thanh toán', N'Giảm 60k', NULL),

-- Ngày 11/11 - HÔM NAY (4 hóa đơn đã thanh toán)
(3, 7, 5, '2025-11-11 08:00:00', '2025-11-11 10:00:00', 120000, 135000, 0, 255000, N'Tiền mặt', N'Đã thanh toán', NULL, NULL),
(9, 8, 3, '2025-11-11 10:30:00', '2025-11-11 12:30:00', 120000, 165000, 15000, 270000, N'Chuyển khoản', N'Đã thanh toán', N'Giảm 15k', NULL),
(17, 9, 4, '2025-11-11 14:00:00', '2025-11-11 16:30:00', 150000, 195000, 0, 345000, N'Ví điện tử', N'Đã thanh toán', NULL, NULL),
(25, 10, 5, '2025-11-11 18:00:00', '2025-11-11 20:30:00', 360000, 315000, 50000, 625000, N'Tiền mặt', N'Đã thanh toán', N'Giảm 50k', NULL);

-- HÓA ĐƠN ĐANG CHƠI (11/11 - hiện tại)
INSERT INTO hoa_don (ma_ban, ma_kh, ma_nv, thoi_gian_bat_dau, thoi_gian_ket_thuc, tien_ban, tien_dich_vu, giam_gia, tong_tien, phuong_thuc_thanh_toan, trang_thai, ghi_chu_giam_gia, ghi_chu) VALUES
(2, 1, 3, '2025-11-11 21:00:00', NULL, 0, 85000, 0, 85000, N'Tiền mặt', N'Đang chơi', NULL, N'Gọi Tiger và snack'),
(8, 2, 4, '2025-11-11 21:30:00', NULL, 0, 125000, 0, 125000, N'Chuyển khoản', N'Đang chơi', NULL, N'Gọi Heineken và đồ ăn'),
(12, NULL, 5, '2025-11-11 22:00:00', NULL, 0, 60000, 0, 60000, N'Tiền mặt', N'Đang chơi', NULL, N'Khách lẻ'),
(20, 3, 3, '2025-11-11 22:15:00', NULL, 0, 95000, 0, 95000, N'Ví điện tử', N'Đang chơi', NULL, NULL),
(24, 4, 4, '2025-11-11 22:30:00', NULL, 0, 185000, 0, 185000, N'Tiền mặt', N'Đang chơi', NULL, N'Bàn VIP');
...
-- THỐNG KÊ TỔNG QUAN
-- ==========================================
-- Tổng hóa đơn tháng 10: 35 hóa đơn
-- Tổng hóa đơn tháng 11 (đến 11/11): 25 hóa đơn
-- Tổng doanh thu tháng 10: ~11,500,000 VNĐ
-- Tổng doanh thu tháng 11: ~8,500,000 VNĐ
-- Hóa đơn hôm nay (11/11): 4 hóa đơn đã thanh toán
-- Doanh thu hôm nay: ~1,495,000 VNĐ
